...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const defaultResponseMessage = "Lời tỏ tình của bạn sẽ được gửi đi và bạn sẽ nhận được phản hồi từ người ấy. Hãy kiên nhẫn chờ đợi!";
    ...
    const headerText = "Trang Tỏ Tình Ngọt Ngào";
    typeWriter(document.querySelector(".hero h2"), headerText, 0, function () {
        console.log("Chào mừng bạn đến với trang tỏ tình!");
    });
    ...
    contactForm.addEventListener("submit", function (event) {
        ...
        const messageContact = document.getElementById("message-contact").value.trim();
        ...
        // Hiển thị thông điệp cảm ơn sau khi gửi form
